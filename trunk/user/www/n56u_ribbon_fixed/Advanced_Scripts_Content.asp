                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div id="script0" style="display:none;">
                                                    <textarea rows="24" wrap="off" spellcheck="false" maxlength="9999" class="span12" name="scripts.start_script.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.start_script.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <div id="script1" style="display:none;">
                                                    <textarea rows="24" wrap="off" spellcheck="false" maxlength="9999" class="span12" name="scripts.started_script.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.started_script.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <div id="script5" style="display:none;">
                                                    <textarea rows="24" wrap="off" spellcheck="false" maxlength="9999" class="span12" name="scripts.shutdown_script.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.shutdown_script.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="row_post_wan_script">
                                            <td>
                                                ...
                                                <div id="script2" style="display:none;">
                                                    <textarea rows="24" wrap="off" spellcheck="false" maxlength="9999" class="span12" name="scripts.post_wan_script.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.post_wan_script.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="row_post_iptables_script">
                                            <td>
                                                ...
                                                <div id="script3" style="display:none;">
                                                    <textarea rows="24" wrap="off" spellcheck="false" maxlength="9999" class="span12" name="scripts.post_iptables_script.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.post_iptables_script.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding-bottom: 0px;">
                                                ...
                                                <div id="script4" style="display:none;">
                                                    <textarea rows="24" wrap="off" spellcheck="false" maxlength="9999" class="span12" name="scripts.ez_buttons_script.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.ez_buttons_script.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
